...
def output_to_excel(data_lists, excel_outputs):
    ...
    for list in data_lists:
        ...
        if language_listed:
            ...
            worksheet.write(6, col, 'Chinese Models')
            worksheet.write(7, col, 'Other Asian Models')
            worksheet.write(8, col, 'Non-Asian Models')
            worksheet.write(11, col, 'Chinese Total')
            worksheet.write(12, col, 'Other Asian Total')
            worksheet.write(13, col, 'Non-Asian Total')
        ...
        if language_listed:
            ...
            worksheet.write(1, chinese_results_col+1, chinese_levels)
            worksheet.write(2, chinese_results_col, f"{other_asian_level_percentage:.2%}")
            worksheet.write(2, chinese_results_col+1, other_asian_levels)
            worksheet.write(3, chinese_results_col, f"{non_asian_level_percentage:.2%}")
            worksheet.write(3, chinese_results_col+1, non_asian_levels)
            worksheet.write(4, chinese_results_col+1, chinese_levels+other_asian_levels+non_asian_levels)
            worksheet.write(6, chinese_results_col, f"{chinese_model_percentage:.2%}")
            worksheet.write(6, chinese_results_col+1, chinese_models)
            worksheet.write(7, chinese_results_col, f"{other_asian_model_percentage:.2%}")
            worksheet.write(7, chinese_results_col+1, other_asian_models)
            worksheet.write(8, chinese_results_col, f"{non_asian_model_percentage:.2%}")
            worksheet.write(8, chinese_results_col+1, non_asian_models)
            worksheet.write(9, chinese_results_col+1, chinese_models+other_asian_models+non_asian_models)
            worksheet.write(11, chinese_results_col, f"{chinese_total_percentage:.2%}")
            worksheet.write(11, chinese_results_col+1, chinese_levels + chinese_models)
            worksheet.write(12, chinese_results_col, f"{other_asian_total_percentage:.2%}")
            worksheet.write(12, chinese_results_col+1, other_asian_levels + other_asian_models)
            worksheet.write(13, chinese_results_col, f"{non_asian_total_percentage:.2%}")
            worksheet.write(13, chinese_results_col+1, non_asian_levels + non_asian_models)
            worksheet.write(14, chinese_results_col+1, chinese_levels+chinese_models+other_asian_levels+other_asian_models+non_asian_levels+non_asian_models)
